    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <motion.div
                ...
                animate="visible"
                variants={fadeUp}
                className="inline-flex items-center gap-2 bg-rose-100 text-rose-700 text-xs font-medium px-3 py-1.5 rounded-full mb-6"
              >
              ...
              <motion.h1
                ...
                animate="visible"
                variants={fadeUp}
                className="text-4xl lg:text-5xl font-bold text-stone-800 leading-tight mb-4"
              >
                {t.heroTitle}
              </motion.h1>
              ...
              >
                <Link
                  href="/flowers"
                  className="inline-flex items-center gap-2 bg-rose-500 hover:bg-rose-600 text-white font-medium px-6 py-3 rounded-xl transition-all hover:shadow-lg hover:shadow-rose-200 hover:-translate-y-0.5"
                >
              ...
              <motion.div
                ...
                animate="visible"
                variants={fadeUp}
                className="flex items-center gap-6 mt-8 pt-8 border-t border-stone-100"
              >
                {[
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {services.map((s, i) => (
              ...
              >
                <Link
                  href={s.href}
                  className={`group p-6 rounded-2xl border border-stone-100 hover:border-${s.color}-200 hover:shadow-md transition-all bg-stone-50 hover:bg-${s.color}-50 block`}
                >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/gift-cards"
            className="inline-flex items-center gap-2 bg-white text-rose-500 hover:bg-rose-50 font-semibold px-6 py-3 rounded-xl transition-colors hover:-translate-y-0.5 hover:shadow-lg"
          >
